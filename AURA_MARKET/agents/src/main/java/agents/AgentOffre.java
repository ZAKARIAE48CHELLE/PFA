...
/**
 * Agent JADE responsable de la génération d'offres de prix.
 *
 * Formule de calcul :
 *   D(%) = clamp(5, 50, (10 + 4*log10(prixBase+1) + 3*(4.5-note)) * Cf)
 *   Cf = 0.8 si smartphone/laptop/tv, 1.3 si accessoire/cable/casque, 1.0 sinon
 *
 * Ajustement marché via similarPrices :
 *   - marché < 90% du prixBase → facteur 0.95
 *   - marché > 110% du prixBase → facteur 1.03
 */
            ...
            public void action() {
                ...
                if (msg != null) {
                    try {
                        ...
                        // Support both formats to avoid breaking the old requests
